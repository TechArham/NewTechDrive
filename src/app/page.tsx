...
export default function Home() {
  ...
  return (
    <div className="text-white flex flex-col items-center font-sans overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Badges */}
                    <div className="hidden md:flex flex-wrap gap-6 items-center pt-8">
                      {badges.map((badge, idx) => (
                        <div key={idx} className="text-zinc-400 text-xs md:text-sm font-semibold flex items-center gap-2">
                          {badge}
                        </div>
                      ))}
                    </div>
